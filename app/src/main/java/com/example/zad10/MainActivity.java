...
public class MainActivity extends AppCompatActivity {
    public static String KEY_EXTRA_TITLE = "Title";
    public static String KEY_EXTRA_AUTHOR = "Author";
    public static String KEY_EXTRA_IMAGE = "Image";
    ...
    private class BookHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void bind(Book book){
            ...
            if (book != null && checkNullOrEmpty(book.getTitle()) && book.getAuthors() != null){
                ...
                if (book.getCover() != null){
                    Picasso.with(itemView.getContext()).load(IMAGE_URL_BASE + book.getCover() + "-M.jpg").placeholder(R.drawable.ic_baseline_book_24).into(bookCover);
                }
                else{
        ...
        public void onClick(View view) {
            ...
            intent.putExtra(KEY_EXTRA_IMAGE, book.getCover());
